...
class NMPCRabbit(Node):
    ...
    def __init__(self):
        super().__init__('nmpc_params_node')
        ## NMPC Params
        ...
        self.declare_parameters(
            namespace='',
            parameters=[
                ('lowX', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('highX', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('lowU', rclpy.Parameter.Type.DOUBLE),
                ('highU', rclpy.Parameter.Type.DOUBLE),
                ('mat_Q', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('mat_R', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('prediction_horizons', rclpy.Parameter.Type.INTEGER),
                ('step_time', rclpy.Parameter.Type.DOUBLE),
                ('mpciter', rclpy.Parameter.Type.INTEGER),
                ('mpc_timer', rclpy.Parameter.Type.DOUBLE),
                ('control_timer', rclpy.Parameter.Type.DOUBLE),
                ('wheel_topic', rclpy.Parameter.Type.STRING),
                ('imu_topic', rclpy.Parameter.Type.STRING),
                ('control_topic', rclpy.Parameter.Type.STRING),
                ('path_topic', rclpy.Parameter.Type.STRING),
                ('current_state', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('current_control', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('goal_path', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('offset', rclpy.Parameter.Type.DOUBLE),
                ('search_index', rclpy.Parameter.Type.INTEGER),
                ('previous_index', rclpy.Parameter.Type.INTEGER),
                ('next_index', rclpy.Parameter.Type.INTEGER),
                ('index', rclpy.Parameter.Type.INTEGER),
                ('dind', rclpy.Parameter.Type.INTEGER),
                ('startX', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('endX', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('goal_flag', rclpy.Parameter.Type.BOOL),
                ('hold_state', rclpy.Parameter.Type.BOOL),
                ('opt_control', rclpy.Parameter.Type.DOUBLE_ARRAY),
                ('norm_cond', rclpy.Parameter.Type.DOUBLE),
                ('n_points', rclpy.Parameter.Type.INTEGER)
            ]
        )
