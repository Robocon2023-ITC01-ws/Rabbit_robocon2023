...
goal2 = np.vstack([path_x2, path_y2, np.linspace(1.57, 0.0, 100)])
...
goal3 = np.vstack([path_x3, path_y3, path_yaw3])
...
goal4 = np.vstack([path_x4, path_y4, path_yaw4])
...
# 
# np.savetxt('/home/kenotic/ros2ocp_ws/src/ocp_robocon2023/ocp_robocon2023/library/path1.csv', goal, delimiter=",")

goal = np.loadtxt('/home/kenotic/ros2ocp_ws/src/ocp_robocon2023/ocp_robocon2023/library/path1.csv', delimiter=',', dtype=np.float32)
